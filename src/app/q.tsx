...
export default function QuantumCoursePitch() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      {/* Enhanced Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-black/90 backdrop-blur-xl border-b border-cyan-500/20">
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <div className="flex justify-center space-x-4 mb-8">
              <Badge variant="outline" className="border-cyan-500/50 text-cyan-400 bg-cyan-500/10 animate-bounce">
                <Sparkles className="w-3 h-3 mr-1" />
                Interactive Learning
              </Badge>
              <Badge
                variant="outline"
                className="border-purple-500/50 text-purple-400 bg-purple-500/10 animate-bounce"
            ...
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-12">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">{animatedStats.students}+</div>
                <div className="text-sm text-gray-400">Students Reached</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">{animatedStats.completion}%</div>
                <div className="text-sm text-gray-400">Completion Rate</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-pink-400 mb-2">{animatedStats.satisfaction}%</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                size="lg"
                className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white text-lg px-8 py-4 rounded-full shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105"
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-cyan-500/50 text-cyan-400 hover:bg-cyan-500/10 text-lg px-8 py-4 rounded-full bg-transparent"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Impact & Access",
                description:
                  "Free for schools via sponsorships; premium version at $99/student for individuals, with proceeds funding access for low-income participants.",
                color: "green",
                stat: "$99 Premium",
              },
            ].map((item, index) => (
      ...
      <section id="pitch-closer" className="relative z-10 py-20 px-4">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Ready to revolutionize quantum education? Let's discuss this
                <span className="text-green-400"> game-changing opportunity</span>
              </p>
            </div>
            ...
            <Card className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 border-gray-700/50 backdrop-blur-sm shadow-2xl">
              <CardHeader>
                ...
                <CardDescription className="text-center text-gray-300 text-lg">
                  Ready to revolutionize quantum education? Let's discuss this opportunity.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-gray-800/50 border-gray-600/50 text-white placeholder-gray-400 focus:border-cyan-500/50 focus:ring-cyan-500/20 transition-all duration-300"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      id="message"
                      placeholder="Tell us about your interest in this quantum computing course..."
                      rows={4}
                      className="bg-gray-800/50 border-gray-600/50 text-white placeholder-gray-400 focus:border-cyan-500/50 focus:ring-cyan-500/20 transition-all duration-300"
                    />
                  </div>
                  <Button className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white text-lg py-4 rounded-full shadow-2xl hover:shadow-cyan-500/25 transition-all duration-300 transform hover:scale-105">
